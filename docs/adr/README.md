...
Each ADR follows the same shape: Status, Context, Decision, Consequences, Links. Keep them short and decisive. If an ADR is superseded, mark its status and link to the successor — do not delete.
