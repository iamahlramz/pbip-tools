    ...
    params: [
      {
        name: 'valueMeasure',
        type: 'string',
        description: 'DAX measure reference returning 0-1 value',
        required: true,
      },
      ...
      { name: 'height', type: 'number', description: 'SVG height in pixels', defaultValue: 20 },
      {
        ...
        defaultValue: '%23E0E0E0',
      },
      {
        name: 'goodColor',
        type: 'color',
        description: 'Color when above target',
        defaultValue: '%2322C55E',
      },
      {
        name: 'warningColor',
        type: 'color',
        description: 'Color when at risk',
        defaultValue: '%23F59E0B',
      },
      {
        name: 'badColor',
        type: 'color',
        description: 'Color when behind target',
        defaultValue: '%23EF4444',
      },
      {
        name: 'warningThreshold',
        type: 'number',
        description: 'Threshold for warning color (0-1)',
        defaultValue: 0.7,
      },
      {
        name: 'goodThreshold',
        type: 'number',
        description: 'Threshold for good color (0-1)',
        defaultValue: 0.9,
      },
    ...
    params: [
      {
        name: 'valueMeasure',
        type: 'string',
        description: 'DAX measure reference for current value',
        required: true,
      },
      {
        name: 'targetMeasure',
        type: 'string',
        description: 'DAX measure reference for target value',
        required: true,
      },
      { name: 'title', type: 'string', description: 'Card title text', defaultValue: 'KPI' },
      {
        name: 'format',
        type: 'string',
        description: 'FORMAT() pattern for value display',
        defaultValue: '#,##0',
      },
      {
        name: 'goodColor',
      ...
      },
      {
        name: 'badColor',
        type: 'color',
        description: 'Color when below target',
        defaultValue: '%23EF4444',
      },
    ...
    params: [
      {
        name: 'valueMeasure',
        type: 'string',
        description: 'DAX measure reference',
        required: true,
      },
      {
        name: 'goodThreshold',
        type: 'number',
        description: 'Threshold for good status',
        defaultValue: 0.9,
      },
      {
        name: 'warningThreshold',
...
RETURN
  ...
  },
  {
    ...
    description: 'A toggle switch visual that shows on/off state based on a boolean measure.',
    category: 'Interactive',
    params: [
      {
        name: 'valueMeasure',
        type: 'string',
        description: 'DAX measure returning TRUE/FALSE or 1/0',
        required: true,
      },
